...
`; },
  apply() {
    return g.reputation.Tomenoi = 0;
  }
};

export var JamesUpsetMagic = {
  where: 'Vailia|Ch2',
...
`; },
  apply() {
    return g.reputation.Nonkenia = 0;
  }
};

export var NonkeniaDiplomat = {
  where: 'Vailia|Ch2',
...
`; },
  apply() {
    return g.reputation.IronSands = 0;
  }
};

export var AsaraTalkFlames = {
  where: 'Vailia|Ch2',
...
`; },
  apply() {
    g.chapter = 'Ch3';
    g.history.Ch3 = g.day;
    return Game.showOverlay('<h1>Chapter 3</h1><h3>James</h3>', 0, 'chapter overlay');
  }
};

export var JamesCh3No = {
  where: 'Vailia|Ch2',
