...
`; },
  apply() {
    ...
    return g.reputation.Kantis = 0;
  }
};

export var TomenoiHistory = {
  where: 'Tomenoi|Ch2',
  label: 'History',
  history: {
    TomenoiArrive: true
