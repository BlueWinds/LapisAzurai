...
export var AlkeniaWeaponsRunning = {
  where: 'Alkenia|Ch2',
  label: 'Forestry',
  history: {
    Ch2: true
...
export var AlkeniaWeaponsRunning2 = {
  where: 'Alkenia|Ch2',
...
`; },
  apply() {
    g.chapter = 'Ch3';
    g.history.Ch3 = g.day;
    return Game.showOverlay('<h1>Chapter 3</h1><h3>Kat</h3>', 0, 'chapter overlay');
  }
};
