...
`; },
  apply() {
    return Game.showOverlay('<h1>Chapter 1</h1><h3>Vailia</h3>', 0, 'chapter overlay');
  }
};

export var ReadyToGo = {
  where: 'Vailia|Ch1',
...
`; },
  apply() {
    return g.reputation.Alkenia = 0;
  }
};


export var MeetMeghan = {
  where: 'Vailia|Ch1',
  label: 'Lady Meghan',
...
`; },
  apply() {
    g.chapter = 'Ch2';
    return Game.showOverlay('<h1>Chapter 2</h1><h3>Kantis</h3>', 0, 'chapter overlay');
  }
};
