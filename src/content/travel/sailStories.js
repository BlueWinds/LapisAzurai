...
export var ShipPracticeReading = {
  where: 'Sail',
...
export var AbandonedShipSearch = {
  where: 'Sail',
  label: 'Abandoned Ship',
  extraDays: 10000,
  history: {
