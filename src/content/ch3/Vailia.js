...
export var Ch3 = {
  ...
  extraDays() {
    const max = Math.max(expirationDate('AsaraCh3Yes'), expirationDate('KatCh3Yes'), expirationDate('JamesCh3Yes'));
...
export var NonkeniaDiplomatConclusion = {
  where: 'Vailia|Ch3',
